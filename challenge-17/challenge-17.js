(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Jackson Dias da Silva Junior'))
    ...
    */
    ...
    function getMonthNumber(mouthName) {
        var mouths = {
            janeiro: '01',
            fevereiro: '02',
            'março': '03',
    ...
    */
    console.log('\nReplace de datas:');
    function replaceDate(regex, day, mouth, year) {

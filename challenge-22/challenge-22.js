(function (win, doc) {
  /*
    ...
    */
  var pessoa1 = { name: 'junior', lastName: 'Silva' };
  var pessoa2 = { name: 'Jackson', lastName: 'Dias' };
  /*
  ...
  */
  ...
  console.log(sum(2, 5, 6, 15, 9))
  console.log(sum(2, 2, 6, 8, 9))
  console.log(sum(2, 5, 8, 8, 291))
  /*
  ...
  */
  ...
  console.log(justNumbers('ju312ja1212ka12'))
  /*
